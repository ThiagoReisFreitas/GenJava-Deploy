...
public class UsuarioControllerTest {
	...
	void start() {
		...
		usuarioService.cadastroUsuario(new Usuario(
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(
				0L, "Paulo Antunes", "paulo_antunes@email.com.br", "12345678", "-"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastroUsuario(new Usuario(
				0L, "Maria da Silva", "maria_silva@email.com", "12345678", "-"));
	...
	public void deveAtualizarUmUsuario() {
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastroUsuario(new Usuario(
				0L, "Juliana Andrews Ramos", "juliana_ramos@email.com.br", "juliana123", "-"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastroUsuario(new Usuario(0L,
